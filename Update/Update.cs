...
{   
    public partial class Update : Form
    {
        ...
        private void loadListView()
        {
            ...
            listView3.Columns.Add("Column Names", -2, HorizontalAlignment.Left);
        ...
        private void checkedListBox_SelectedIndexChanged(object sender, EventArgs e)
        {
                ...
                || checkedListBox.GetItemCheckState(1) == CheckState.Checked)
            {
                ...
                for (int i = 0; i < listView1.Items.Count; i++)
                {
                    ...
                    {
                        loadListView3(listView1.Items[i].Text);
        ...
        private void loadListView2(string name)
        {
            ...
            string query = $"SELECT column_name FROM USER_COL_PRIVS WHERE GRANTEE = '{username}' AND TABLE_NAME = '{name}' AND (PRIVILEGE = 'SELECT' OR PRIVILEGE = 'UPDATE')";
            ...
            using (OracleCommand cmd = new OracleCommand(query, connection.connection))
            {
                using (OracleDataReader reader = cmd.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        ListViewItem item = new ListViewItem($"{name}.{columnName}");
        ...
        private void loadListView3(string name)
        {
