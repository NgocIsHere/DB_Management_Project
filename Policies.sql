...
WHERE (( EXTRACT(MONTH FROM CURRENT_DATE) = 1 AND HK = 1) OR (EXTRACT(MONTH FROM CURRENT_DATE) = 5 AND HK = 2) OR ( EXTRACT(MONTH FROM CURRENT_DATE) = 9) AND HK = 3)
AND EXTRACT(DAY FROM CURRENT_DATE) < 15 AND EXTRACT(YEAR FROM CURRENT_DATE) = NAM ;
