...
INSERT INTO PROJECT_OLS_THONGBAO VALUES(8,to_date('2024-1-12','YYYY-MM-DD'), 'THONG BAO NAY DANH CHO NHANVIENCOBAN  CO SO 1 VA CO SO 2',N'Các nhân viên có tên Duy được nhân đôi lương');
...
BEGIN
    ...
    SA_LABEL_ADMIN.CREATE_LABEL (
        policy_name  => 'AGENCY_POLICY',
        label_tag    => 1800,
        label_value  => 'NV', -- HIGHLY_SENSITIVE level for the HR compartment
        data_label   => TRUE);
END;
/
...
WHERE ID = 7;
UPDATE ADMIN_OLS.PROJECT_OLS_THONGBAO
SET AGENCY_LABEL = CHAR_TO_LABEL('AGENCY_POLICY','NV')
WHERE ID = 8;
--
...
UPDATE ADMIN_OLS.PROJECT_DONVI SET  MADV = 'CNTT' , TENDV = N'Bộ môn CNTT' , TRGDV = N'5'  WHERE MADV = 'CNTT'
UPDATE ADMIN_OLS.PROJECT_DONVI SET  MADV = 'CNSH' , TENDV = N'Công nghệ Sinh Học' , TRGDV = N'8'  WHERE MADV = 'CNSH'
...
SELECT granted_role FROM user_role_privs where granted_role = 'SYSDBA' ORDER BY granted_role DESC

INSERT INTO ADMIN_OLS.PROJECT_SINHVIEN (MASV, HOTEN, PHAI, NGSINH, DCHI, DT, MACT, MANGANH, SOTCTL, DTBTL) VALUES (4002, N'123123', N'Nữ', TO_DATE('2024-06-05', 'yyyy-mm-dd'), N'1231232', '12313123123', 'CQ', HTTT, 4, 6)

INSERT INTO ADMIN_OLS.PROJECT_SINHVIEN (MASV, HOTEN, PHAI, NGSINH, DCHI, DT, MACT, MANGANH, SOTCTL, DTBTL) VALUES (4002, N'NGUYỄN VĂN TRUNG', N'Nam', TO_DATE('2024-05-29', 'yyyy-mm-dd'), N'123', '1231223', 'CQ', HTTT, 4, 6)

SELECT* FROM ADMIN_OLS.PROJECT_SINHVIEN where masv = 4009

SELECT * FROM ROLE_TAB_PRIVS WHERE (TABLE_NAME LIKE '%_SINHVIEN%')

SELECT * FROM ROLE_TAB_PRIVS WHERE (TABLE_NAME LIKE '%_SINHVIEN%') AND PRIVILEGE = 'UPDATE'
UPDATE ADMIN_OLS.PROJECT_SINHVIEN SET  MASV = '5' , HOTEN = N'Hoàng Thị Huy' , PHAI = N'Nam' , NGSINH = TO_DATE('2004-10-19', 'yyyy-mm-dd'),  DT = '6047346789' ,  MACT = 'CTTT' ,  MANGANH = 'HTTT' ,  SOTCTL = 4,  DTBTL = 4.733333 WHERE MASV = '5'


UPDATE ADMIN_OLS.PROJECT_SINHVIEN SET  MASV = '7' , HOTEN = N'Lê Văn Linh' , PHAI = N'Nữ' , NGSINH = TO_DATE('2003-01-28', 'yyyy-mm-dd'),  DT = '8160025589' ,  MACT = 'CLC' ,  MANGANH = 'TGMT' ,  SOTCTL = 4,  DTBTL = 4.866667 WHERE MASV = '7'
select* from ADMIN_OLS.PROJECT_SINHVIEN
UPDATE ADMIN_OLS.PROJECT_HOCPHAN SET  MAHP = 'CSDL' , TENHP = N'Cơ sở dữ liệu' , SOTC = 4 , SSLT = 60 , STTH = 30 , SOSVTD = 100 , MADV = 'VPK'  WHERE MAHP = 'CSDL'
select* from ADMIN_OLS.PROJECT_HOCPHAN
UPDATE ADMIN_OLS.PROJECT_DONVI SET  MADV = 'CNTT' , TENDV = N'Bộ môn CNTT' , TRGDV = N'5'  WHERE MADV = 'CNTT'


SELECT * FROM USER_TAB_PRIVS WHERE GRANTEE LIKE 'PROJECT_U_%' AND PRIVILEGE = 'SELECT' AND TABLE_NAME NOT LIKE 'PROJECT_U_%' AND TABLE_NAME LIKE '%NHANSU'
SELECT * FROM ROLE_TAB_PRIVS WHERE (TABLE_NAME LIKE '%_NVCOBAN_%' OR TABLE_NAME LIKE '%_NHANSU%')  AND PRIVILEGE = 'UPDATE'
